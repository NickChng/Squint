...
namespace VMSTemplates
{
    ...
    public partial class ProtocolPhasesPhase
    {
        ...
        private ushort? fractionsPerWeekField;

        private ushort? fractionsPerDayField;
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(IsNullable = true)]
        public ushort? FractionsPerWeek
        {
            get
            {
    ...
    public partial class ProtocolPhasesPhasePrescriptionMeasureItem
    {
        ...
        private double? typeSpecifierField;
